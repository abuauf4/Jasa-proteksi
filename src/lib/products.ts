...
export const products: InsuranceProduct[] = [
  {
    ...
    discount: "Diskon 25% + Cashback 20%",
    iconName: "Car",
    ...
    highlights: [
      ...
      { icon: "cashback", label: "Cashback", value: "Hingga 20%" },
      { icon: "discount", label: "Diskon", value: "25%" },
    ...
    variants: [
      ...
      { name: "Mobil Listrik TLO", price: "Mulai Rp 1,5jt/tahun" },
  ...
  },
  {
    ...
    highlights: [
      { icon: "shield", label: "Tipe", value: "TLO / All Risk" },
      { icon: "speed", label: "Proses", value: "5 Menit" },
  ...
  },
  {
    ...
    highlights: [
      ...
      { icon: "discount", label: "Diskon", value: "10%" },
      { icon: "price", label: "Premi", value: "Mulai 50rb" },
    ],
    claimTypes: ["Reimbursement"],
    variants: [
