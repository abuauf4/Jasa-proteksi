    ...
    <section id="model" className="bg-white overflow-hidden">
      <div className="py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          {/* Header Row */}
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-8 mb-16 lg:mb-20">
            <div>
            ...
            <div className="inline-flex gap-1 p-1 rounded-lg bg-gray-50/80 border border-gray-100 flex-wrap">
              {categories.map((cat) => (
                <button
                  ...
                  className={`px-5 py-2 text-[11px] font-medium tracking-wider transition-all duration-500 rounded-md ${
                    active === cat
            ...
            <AnimatePresence mode="wait">
              {filtered.map((product, i) => {
                ...
                return (
                  ...
                  >
                    <div className="rounded-xl overflow-hidden h-full flex flex-col bg-white border border-gray-100 hover:border-[#2E7D6F]/20 transition-all duration-600 hover:shadow-sm group">
                      {/* Icon Header */}
