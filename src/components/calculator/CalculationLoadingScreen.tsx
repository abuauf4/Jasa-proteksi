...
/**
 * Full-screen loading overlay for initial premium calculation.
 * Shows skeleton preview of result page.
 * Not used for recalculation (that uses subtle inline indicator).
 */
export function CalculationLoadingScreen() {
  return (
    <div
      className="fixed inset-0 z-[100] bg-[#F8FAFC] flex flex-col items-center justify-center px-6"
      aria-live="polite"
      aria-busy="true"
      role="status"
    >
      ...
      <div className="w-full max-w-[400px] flex flex-col gap-3">
        ...
        {/* Skeleton: partner grid 4×2 */}
        <div className="grid grid-cols-4 gap-2">
          {Array.from({ length: 8 }).map((_, i) => (
            <div
              key={i}
              className="aspect-square rounded-2xl border border-[#E2E8F0] bg-white flex items-center justify-center"
            >
