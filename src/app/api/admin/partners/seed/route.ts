  ...
  try {
    ...
    const partners = [
      ...
      },
      {
        ...
        slug: "tugu",
        status: "active",
        benefits: JSON.stringify(["Bantuan Claim", "Jaringan Bengkel Luas", "Bengkel Resmi 5 Tahun"]),
        facilities: JSON.stringify(["Free derek", "Layanan call 24 jam"]),
        modifier: 1.0,
        addonModifier: 1.0,
        adminFee: 50000,
        bengkelResmiMaxYears: 5,
        description: "Tugu Insurance - Asuransi kendaraan dengan bengkel resmi 5 tahun",
        sortOrder: 7,
      },
      {
        name: "Sahabat",
        ...
        adminFee: 50000,
        bengkelResmiMaxYears: 5,
        description: "Sahabat Insurance - Asuransi kendaraan terjangkau dengan bengkel resmi 5 tahun",
        sortOrder: 8,
      },
      {
        name: "Oona",
